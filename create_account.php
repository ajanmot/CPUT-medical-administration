  ...
  <div class="grid">
    ...
    <form action="https://httpbin.org/post" method="POST" class="form login">
      ...
      <div class="form__field">
        <label for="createacc_username"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Username</span></label>
        <input id="createacc_username" type="text" name="username" class="form__input" placeholder="Username" required>
      </div>
      <div class="form__field">
